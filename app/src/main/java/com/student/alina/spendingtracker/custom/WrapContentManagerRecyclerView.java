...
import com.student.alina.spendingtracker.BuildConfig;
...
public class WrapContentManagerRecyclerView extends android.support.v7.widget.LinearLayoutManager {
    ...
    public WrapContentManagerRecyclerView(Context context) {
        super(context);
        this.view = null;
    }

    @SuppressWarnings("UnusedDeclaration")
    public WrapContentManagerRecyclerView(Context context, int orientation, boolean reverseLayout) {
